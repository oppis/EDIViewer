                    ...
                    if (!string.IsNullOrEmpty(fileStructur.FormatSeparator))
                    {
                        ...
                        foreach (string fileRow in file)
                        {
                            ...
                            if (returnStatus)
                            {
                                ...
                                {
                                    UserMessageHelper.ShowErrorMessage("Parsen", $"Es wurde die Feld Definition nicht gefunden! \nAktueller Record: {currentRecordType.Name} \nFeld Inhalt: {currentFieldContent}");
                                }
                                catch (Exception ex)
                                {
                                    UserMessageHelper.ShowErrorMessage("Parsen", "Folgender Fehler ist beim Lesen der Datei aufgetreten: \n" + ex.Message);
                                }
                            ...
                            {
                                UserMessageHelper.ShowErrorMessage("Parsen", "Es wurde keine Feld Definition gefunden!\n" + fileRow);
                            }
                            else
                            {
